...
final Map<String, TextEditingController>
    _AddProductsServicesViewTextEditingControllers = {};

final Map<String, FocusNode> _AddProductsServicesViewFocusNodes = {};

final Map<String, String? Function(String?)?>
    _AddProductsServicesViewTextValidations = {
...
mixin $AddProductsServicesView on StatelessWidget {
  ...
  TextEditingController _getFormTextEditingController(String key,
      {String? initialValue}) {
    if (_AddProductsServicesViewTextEditingControllers.containsKey(key)) {
      return _AddProductsServicesViewTextEditingControllers[key]!;
    }
    _AddProductsServicesViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _AddProductsServicesViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_AddProductsServicesViewFocusNodes.containsKey(key)) {
      return _AddProductsServicesViewFocusNodes[key]!;
    }
    _AddProductsServicesViewFocusNodes[key] = FocusNode();
    return _AddProductsServicesViewFocusNodes[key]!;
  }
  ...
  String? _getValidationMessage(String key) {
    final validatorForKey = _AddProductsServicesViewTextValidations[key];
    if (validatorForKey == null) return null;
    String? validationMessageForKey = validatorForKey(
        _AddProductsServicesViewTextEditingControllers[key]!.text);
  ...
  void disposeForm() {
    ...
    for (var controller
        in _AddProductsServicesViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _AddProductsServicesViewFocusNodes.values) {
      focusNode.dispose();
    }

    _AddProductsServicesViewTextEditingControllers.clear();
    _AddProductsServicesViewFocusNodes.clear();
  }
}

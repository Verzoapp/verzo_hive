...
final Map<String, TextEditingController>
    _AddCustomersViewTextEditingControllers = {};

final Map<String, FocusNode> _AddCustomersViewFocusNodes = {};

final Map<String, String? Function(String?)?> _AddCustomersViewTextValidations =
    {
...
mixin $AddCustomersView on StatelessWidget {
  ...
  TextEditingController _getFormTextEditingController(String key,
      {String? initialValue}) {
    if (_AddCustomersViewTextEditingControllers.containsKey(key)) {
      return _AddCustomersViewTextEditingControllers[key]!;
    }
    _AddCustomersViewTextEditingControllers[key] =
        TextEditingController(text: initialValue);
    return _AddCustomersViewTextEditingControllers[key]!;
  }

  FocusNode _getFormFocusNode(String key) {
    if (_AddCustomersViewFocusNodes.containsKey(key)) {
      return _AddCustomersViewFocusNodes[key]!;
    }
    _AddCustomersViewFocusNodes[key] = FocusNode();
    return _AddCustomersViewFocusNodes[key]!;
  }
  ...
  String? _getValidationMessage(String key) {
    final validatorForKey = _AddCustomersViewTextValidations[key];
    if (validatorForKey == null) return null;
    String? validationMessageForKey =
        validatorForKey(_AddCustomersViewTextEditingControllers[key]!.text);
  ...
  void disposeForm() {
    ...
    for (var controller in _AddCustomersViewTextEditingControllers.values) {
      controller.dispose();
    }
    for (var focusNode in _AddCustomersViewFocusNodes.values) {
      focusNode.dispose();
    }

    _AddCustomersViewTextEditingControllers.clear();
    _AddCustomersViewFocusNodes.clear();
  }
}
